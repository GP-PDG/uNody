...
namespace PuppyDragon.uNodyEditor {
	public class OutputAttributeDrawer : OdinAttributeDrawer<PuppyDragon.uNody.Node.OutputAttribute> {
		...
		protected override void DrawPropertyLayout(GUIContent label) {
			...
			if (!NodeEditor.inNodeEditor) {
				if (Attribute.backingValue == PuppyDragon.uNody.Node.ShowBackingValue.Always || Attribute.backingValue == PuppyDragon.uNody.Node.ShowBackingValue.Unconnected && !port.IsConnected)
